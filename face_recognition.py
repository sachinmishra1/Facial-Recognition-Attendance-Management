...
class Face_recognition:
    def __init__(self,root): 
        ...
        img_left = img_left.resize((640,610),Image.ANTIALIAS)
        self.photoimg_left = ImageTk.PhotoImage(img_left)
        lb_left = Label(self.root,image=self.photoimg_left)
        lb_left.place(x=0, y=45, width=640, height=610)

        img_right = Image.open(r"Photos\facerecomain.jpg")
        img_right = img_right.resize((640,610),Image.ANTIALIAS)
        self.photoimg_right = ImageTk.PhotoImage(img_right)
        lb_right = Label(self.root,image=self.photoimg_right)
        lb_right.place(x=640, y=45, width=640, height=610)

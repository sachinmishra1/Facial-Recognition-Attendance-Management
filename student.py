...
class Student:
    def __init__(self,root):
        ...
        #first image
        img = Image.open(r"C:\Users\sachi\Desktop\Face Recognition Attendance Management\Photos\a9.jpg")
        ...
        #second image
        img1 = Image.open(r"C:\Users\sachi\Desktop\Face Recognition Attendance Management\Photos\a7.jpg")
        ...
        #third image
        img2 = Image.open(r"C:\Users\sachi\Desktop\Face Recognition Attendance Management\Photos\a8.jpg")
        ...
        main_frame.place(x=8,y=50,width=1250,height=490)
        ...
        img_left = Image.open(r"C:\Users\sachi\Desktop\Face Recognition Attendance Management\Photos\attendance2.jpg")
        img_left = img_left.resize((600,90),Image.ANTIALIAS) #ANTIALIAS converts high lvl image to low lvl image
        self.photoimg_left = ImageTk.PhotoImage(img_left)

        bg_img = Label(Left_frame,image = self.photoimg_left)
        bg_img.place(x=3,y=0,width=600,height=90)

        
        #current course frame
        current_course_frame = LabelFrame(Left_frame,bd=2,bg="white",relief=RIDGE,text="Current Course Information",font=("times new roman",12,"bold"))
        current_course_frame.place(x=5,y=92,width=600,height=100)
        ...
        class_Student_frame.place(x=5,y=200,width=600,height=245)
        ...
        #class Division
        class_div_label = Label(class_Student_frame,text="Class:",font=("times new roman",12,"bold"),bg="white")
        ...
        class_div_combo.grid(row=1,column=1,padx=3,pady=5,sticky=W)
        ...
        teacher_label.grid(row=3,column=2,padx=5,pady=5,sticky=W)

        teacher_entry = ttk.Entry(class_Student_frame,textvariable=self.var_teacher,width=20,font=("times new roman",12,"bold"))
        teacher_entry.grid(row=3,column=3,padx=5,pady=5,sticky=W)
        ...
        btn_frame.place(x=2,y=170,width=590,height=25)

        save_btn =Button(btn_frame,text="Save",command=self.add_data,width=20,height=1,font=("times new roman",8,"bold"),bg="blue",fg="white")
        save_btn.grid(row=0,column=0)

        update_btn =Button(btn_frame,text="Update",command=self.update_data,width=20,height=1,font=("times new roman",8,"bold"),bg="blue",fg="white")
        update_btn.grid(row=0,column=1)

        delete_btn =Button(btn_frame,text="Delete",command=self.delete_data,width=20,height=1,font=("times new roman",8,"bold"),bg="blue",fg="white")
        delete_btn.grid(row=0,column=2)

        reset_btn =Button(btn_frame,text="Reset",command=self.reset_data,width=20,height=1,font=("times new roman",8,"bold"),bg="blue",fg="white")
        reset_btn.grid(row=0,column=3)

        btn_frame1 = Frame(class_Student_frame,bd=2,relief=RIDGE,bg="white")
        btn_frame1.place(x=2,y=195,width=590,height=25)

        take_photo_btn =Button(btn_frame1,text="Take Photo Sample",command=self.generate_dataset,width=42,height=1,font=("times new roman",8,"bold"),bg="blue",fg="white")
        take_photo_btn.grid(row=0,column=0)

        update_photo_btn =Button(btn_frame1,text="Update Photo Sample",width=42,height=1,font=("times new roman",8,"bold"),bg="blue",fg="white")
        ...
        img_right = Image.open(r"C:\Users\sachi\Desktop\Face Recognition Attendance Management\Photos\a2.jpg")
        img_right = img_right.resize((600,90),Image.ANTIALIAS) #ANTIALIAS converts high lvl image to low lvl image
        ...
        Search_frame.place(x=5,y=92,width=600,height=70)
        ...
        table_frame.place(x=5,y=170,width=600,height=275)

        scroll_x = ttk.Scrollbar(table_frame,orient=HORIZONTAL)
        scroll_y = ttk.Scrollbar(table_frame,orient=VERTICAL)

        self.student_table = ttk.Treeview(table_frame,column=("dep","course","year","sem","id","name","div","roll","gender","dob","phone","teacher","photo"),xscrollcommand=scroll_x.set,yscrollcommand=scroll_y.set)
    ...
    def add_data(self):
        if self.var_dep.get()=="Select Department" or self.var_std_name.get()=="" or self.var_std_id.get()=="":
            ...
            try:
                conn = mysql.connector.connect(host='localhost',user='root',password='root',database='facerecognitionattendance')
    ...
    #=====================fetch====================================
    def fetch_data(self):
        con = mysql.connector.connect(host='localhost',user='root',password='root',database='facerecognitionattendance')
    ...
    def update_data(self):
        if self.var_dep.get()=="Select Department" or self.var_std_name.get()==""or self.var_std_id=="" or self.var_roll=="":
            messagebox.showerror("Error","All fields are required",parent=self.root)
            ...
            try:
                ...
                if Update >0:
                    con = mysql.connector.connect(host='localhost',user='root',password='root',database='facerecognitionattendance')
                    my_cursor=con.cursor()
                    my_cursor.execute("update student set Dep=%s,course=%s,Year=%s,Semester=%s,Name=%s,Division=%s,Roll=%s,Gender=%s,Dob=%s,Phone=%s,Teacher=%s,PhotoSample=%s where Student_id=%s",(
                                                                                                                                                                                                                    self.var_dep.get(),
                                                                                                                                                                                                                    self.var_course.get(),
                                                                                                                                                                                                                    self.var_year.get(),
                                                                                                                                                                                                                    self.var_semester.get(),
